...
const MOCK_ALBUMS = [
  {
    ...
    artist: "Avicii",
    cover: {
      uri: "https://dojiw2m9tvv09.cloudfront.net/69046/product/default4537.jpg",
    },
  },
  {
    id: "2",
    ...
    artist: "David Guetta",
    cover: {
      uri: "https://cdn-images.dzcdn.net/images/cover/10c4cbb8b894ad58a82d3f90acfb9114/1900x1900-000000-81-0-0.jpg",
    },
  },
  {
    id: "3",
        ...
        ListHeaderComponent={() => (
          <View style={{ flexDirection: "row" }}>
            {isScanning ? (
              <AlbumCard
                type="scanning"
                data={{ title: "", progress: scanProgress }}
              />
            ) : (
              <AlbumCard
                type="shuffle"
                onPress={() => console.log("Shuffle play")}
              />
            )}
          </View>
        )}
